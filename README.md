...
- Live orientation lines summarize both current mode and "You are in Step X of 4" section position, include section-specific goal + action lines, show an at-a-glance board snapshot + workflow progress percentage, and provide a one-click **Next step** button
