...
- Live orientation lines summarize current objective + mode + "Step X of 4" position, include section-specific goal + action lines, show an at-a-glance board snapshot + workflow progress percentage, and provide a one-click **Next step** button
